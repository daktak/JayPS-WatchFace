...
#define GRECT_GRAPH GRect(PBL_IF_ROUND_ELSE(19, 1), 1, SCREEN_W - 2*PBL_IF_ROUND_ELSE(19, 1), PBL_IF_EMERY_ELSE(46, PBL_IF_GABBRO_ELSE(36, PBL_IF_ROUND_ELSE(25,34))))
#ifdef ENABLE_DEMO
