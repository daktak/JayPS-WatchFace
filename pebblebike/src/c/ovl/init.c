...
void screen_data_layer_init(Window* window) {
  ...
  set_layer_attr_full(s_data.screenData_layer.field_bottom_left.data_layer, s_data.distance, FONT_BOTTOM_FIELD, PBL_IF_ROUND_ELSE(GTextAlignmentRight, GTextAlignmentCenter), COLOR_DATA, BG_COLOR_DATA, s_data.page_data);
  ...
  set_layer_attr_full(s_data.screenData_layer.field_bottom_right.data_layer, s_data.avgspeed, FONT_BOTTOM_FIELD, PBL_IF_ROUND_ELSE(GTextAlignmentLeft, GTextAlignmentCenter), COLOR_DATA, BG_COLOR_DATA, s_data.page_data);
